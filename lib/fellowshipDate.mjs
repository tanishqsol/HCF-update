...
export const getThirdSaturday = (year, monthIndex) => {
...
export const getNextFellowshipDate = (today = new Date()) => {
...
export const formatFellowshipDate = (date) => {
...
export const getFellowshipDateInfo = (today = new Date()) => {
