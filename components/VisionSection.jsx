    ...
    items: [
      {
        ...
        description:
          "बोस्टन में हिंदी-भाषी लॉग के साथ यीशु मसीह का शुभ समाचार साझा करना और उन्हें विश्वासयोग्य अनुयायी व अगुवा बनने के लिए तैयार करना।",
        icon: "📖",
      },
      {
      ...
      },
      {
        title: "सेवा और पहुँच",
        description:
          "प्रेम और सेवा के कार्यों के माध्यम से स्थानीय हिंदी-भाषी लॉग समुदाय की सेवा करना, नए लोगों को नए देश में ढलने में मदद करना, और सांस्कृतिक जुड़ाव से पुल बनाना।",
        icon: "❤️",
      },
      {
        title: "समग्र विकास",
